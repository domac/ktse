...
<seelog minlevel="debug">
    <outputs>
        <filter levels="debug">
            <rollingfile formatid="sended" type="date" filename="/apps/logs/ktse/ktse.log" datepattern="2006-01-02" />
        </filter>
        <filter levels="info">
            <console formatid="info"/>
            <rollingfile formatid="info" type="date" filename="/apps/logs/ktse/ktse.log"  datepattern="2006-01-02" />
        </filter>
        <filter levels="warn,error,critical">
            <console formatid="error"/>
            <rollingfile formatid="error" type="date" filename="/apps/logs/ktse/ktse_errors.log"  datepattern="2006-01-02" />
        </filter>
    </outputs>
    <formats>
